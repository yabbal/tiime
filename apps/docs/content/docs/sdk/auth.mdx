...
// [{ id: 12345, name: "Mon Entreprise SAS", ... }]
```
...
# 12345  | Mon Entreprise SAS   | SAS
```

**Via l'interface web Tiime :**

Connectez-vous sur [app.tiime.fr](https://app.tiime.fr) — le Company ID apparaît dans l'URL : `app.tiime.fr/companies/12345/...`
...
| `TIIME_COMPANY_ID` | ID de l'entreprise ([comment le trouver ?](#trouver-votre-company-id)) |
